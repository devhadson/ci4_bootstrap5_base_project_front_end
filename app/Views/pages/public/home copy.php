                ...
                <div class="col-lg-6">
                    <div class="row gx-3 h-100">
                        <div class="col-6 align-self-start wow fadeInUp" data-wow-delay="0.1s">
                            <img class="img-fluid" src="<?= base_url('public/img/about-1.jpg') ?>">
                        </div>
                        <div class="col-6 align-self-end wow fadeInDown" data-wow-delay="0.1s">
                            <img class="img-fluid" src="<?= base_url('public/img/about-2.jpg') ?>">
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative me-lg-4">
                        <img class="img-fluid w-100" src="<?= ('public/img/feature.jpg') ?>" alt="">
                        <span
            ...
            <div class="row gy-5 gx-4">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        <img class="img-fluid" src="<?= base_url('public/img/service-1.jpg') ?>" alt="">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        <img class="img-fluid" src="<?= base_url('public/img/service-2.jpg') ?>" alt="">
                        <div class="service-img">
                            <img class="img-fluid" src="<?= base_url('public/img/service-2.jpg') ?>" alt="">
                        </div>
                        <div class="service-detail">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        <img class="img-fluid" src="<?= ('public/img/service-3.jpg') ?>" alt="">
                        <div class="service-img">
                            <img class="img-fluid" src="<?= ('public/img/service-3.jpg') ?>" alt="">
                        </div>
                        <div class="service-detail">
    ...
    <div class="container-fluid bg-dark pt-5 my-5 px-0">
        ...
        <div class="owl-carousel project-carousel wow fadeIn" data-wow-delay="0.1s">
            <a class="project-item" href="">
                <img class="img-fluid" src="<?= ('public/img/project-1.jpg') ?>" alt="">
                <div class="project-title">
                    <h5 class="text-primary mb-0">Auto Engineering</h5>
                </div>
            </a>
            <a class="project-item" href="">
                <img class="img-fluid" src="<?= ('public/img/project-2.jpg') ?>" alt="">
                <div class="project-title">
                    <h5 class="text-primary mb-0">Civil Engineering</h5>
                </div>
            </a>
            <a class="project-item" href="">
                <img class="img-fluid" src="<?= ('public/img/project-3.jpg') ?>" alt="">
                <div class="project-title">
                    <h5 class="text-primary mb-0">Gas Engineering</h5>
                </div>
            </a>
            <a class="project-item" href="">
                <img class="img-fluid" src="<?= ('public/img/project-4.jpg') ?>" alt="">
                <div class="project-title">
                    <h5 class="text-primary mb-0">Power Engineering</h5>
                </div>
            </a>
            <a class="project-item" href="">
                <img class="img-fluid" src="<?= ('public/img/project-5.jpg') ?>" alt="">
                <div class="project-title">
                    <h5 class="text-primary mb-0">Energy Engineering</h5>
                </div>
            </a>
            <a class="project-item" href="">
                <img class="img-fluid" src="<?= ('public/img/project-6.jpg') ?>" alt="">
                <div class="project-title">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center">
                    <div class="testimonial-img position-relative">
                        <img class="img-fluid rounded-circle mx-auto mb-5" src="<?= ('public/img/testimonial-1.jpg') ?>">
